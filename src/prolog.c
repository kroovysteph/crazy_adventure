...
void print_prolog(void)
{
    ...
    printf("\t\t\tstill standing on the streets. All Empty. The\n");
    printf("\t\t\tsilence of this  place is  overwhelming.  You\n");
    printf("\t\t\tcan see a sign  that  reveals the name of the\n");
    printf("\t\t\tcity to you. It says \"London\".  At this point\n");
    printf("\t\t\tyou just  want to find out in whose house you\n");
    printf("\t\t\tare in and  who you are - or might have been.\n");
